...
const RegisterPage = () => {
	...
	const canBeSubmitted = () => {
		const errors = validate(username, email, firstName, lastName, password, confirmPassword);
	...
	const validate = (username, email, firstName, lastName, password, confirmPassword) => {
							...
							<StyledSection>
								...
								<StyledFormGroup>
									...
									{shouldMarkError('firstName') && (
										<small id="firstNameHelp" className="form-text alert alert-danger">
											{!firstName
							...
							<StyledSection>
								<StyledFormGroup>
									...
									{shouldMarkError('email') && (
										<small id="emailHelp" className="form-text alert alert-danger">
											{!email ? 'Email is required!' : 'Invalid e-mail address!'}
										</small>
									)}
								</StyledFormGroup>
								...
								<StyledFormGroup>
									...
									{shouldMarkError('lastName') && (
										<small id="lastNameHelp" className="form-text alert alert-danger">
											{!lastName
								...
								<StyledFormGroup>
									...
									<StyledInput
										type="password"
										className={
											'form-control ' + (shouldMarkError('confirmPassword') ? 'error' : '')
										}
										id="confirmPassword"
									...
									{shouldMarkError('confirmPassword') && (
										<small id="confirmPasswordHelp" className="form-text alert alert-danger">
